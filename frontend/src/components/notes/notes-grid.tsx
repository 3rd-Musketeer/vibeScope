...
export function NotesGrid() {
    ...
    return (
      <Card className="h-full flex flex-col">
        <CardHeader className="flex-shrink-0 pb-4">
          <CardTitle className="text-base font-semibold">笔记视图 (0)</CardTitle>
        </CardHeader>
  ...
  return (
    <Card className="h-full flex flex-col">
      <CardHeader className="flex-shrink-0 pb-4">
        <CardTitle className="text-base font-semibold mb-4">笔记视图 ({successfulTasks.length})</CardTitle>
