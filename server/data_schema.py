...
if __name__ == "__main__":
    ...
    print(
        f"✓ Nested access: title='{db_record.base_content.title}', author='{db_record.author_profile.author_name}'"
    )
    print(
        f"✓ Component assembly: {len(db_record.comments)} comments, {len(db_record.image_assets)} assets"
    )
