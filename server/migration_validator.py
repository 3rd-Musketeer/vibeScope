...
from api_schema import ExtractedContentResponse, ProjectCreateRequest, TaskCreateRequest
...
async def validate_api_transformation(db_record: DBSchema):
    ...
    try:
        ...
        assert (
            api_response.author_profile.author_name
            == db_record.author_profile.author_name
        )
...
async def validate_request_schemas():
    ...
    try:
        ...
        task_request = TaskCreateRequest(
            project_id="migration-test", url="https://example.com/test-post"
        )
        ...
        html_request = TaskCreateRequest(
            project_id="migration-test", html="<html><body>Test HTML</body></html>"
        )
...
async def validate_fail_fast_behavior():
    ...
    try:
        ...
        try:
            ...
            print(
                f"✅ Fail-fast validation caught error: {type(validation_error).__name__}"
            )
...
async def run_full_migration_validation():
    ...
    try:
        ...
        await validate_api_transformation(db_record)
